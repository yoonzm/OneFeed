...
- **Supported now:** Zhihu, the X home timeline, V2EX, Linux DO, Hacker News, and 36Kr news feeds and article pages.
- **Planned:** Weibo, Xiaohongshu, Reddit, Bilibili, and YouTube.
...
OneFeed is still at an early stage. Text-oriented platforms and stable reading flows take priority over adding large numbers of media-heavy adapters.
