...
| **2.1 综合资讯扩展（已完成）** | 验证多频道资讯列表与同文档增量加载 | 36Kr | 资讯频道、标题、摘要、封面、作者、主题与“查看更多”加载 |
...
Phase 2 前期不以 Adapter 数量为 KPI，而以文字阅读链路的稳定性为先。当前正式支持知乎、V2EX、Linux DO、Hacker News 与 36Kr 资讯频道；X、微博、小红书、Reddit、哔哩哔哩和 YouTube 均为待支持平台。Schema 理论上能够表达某个平台，不代表已经交付该平台适配；平台支持状态和适配进度以 README 为准。
